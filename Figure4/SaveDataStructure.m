...
[~, beflist] = system(sprintf('find "%s" -type f -name "processedTraces_*.mat"', befbasedir));
...
%Day 1
CTLorder_befD1 = [9, 1, 3, 13, 15];  %8, 10, 11, M1, M2
TBIorder_befD1 = [7, 11, 5, 17]; %6, 9, 12, S5
%Day 2
CTLorder_befD2 = [10, 2, 4, 14, 16];  %8, 10, 11, M1, M2
TBIorder_befD2 = [8, 12, 6, 18]; %6, 9, 12, S5
% %All Cells
...
[~, list] = system(sprintf('find "%s" -type f -name "processedTraces_*.mat"', basedir));
...
%Day 1
CTLorder_aftD1 = [9, 1, 3, 13, 15];  %8, 10, 11, M1, M2
TBIorder_aftD1 = [7, 11, 5, 17]; %6, 9, 12, S5
%Day2
CTLorder_aftD2 = [10, 2, 4, 14, 16];  %8, 10, 11, M1, M2
TBIorder_aftD2 = [8, 12, 6, 18]; %6, 9, 12, S5
% %All Cells
...
%save('allData.mat','expMouse','ctlMouse')
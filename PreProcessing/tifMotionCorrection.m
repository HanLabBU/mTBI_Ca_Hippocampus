function tifMotionCorrection()

    fprintf(['Select files for generating ROI and traces\n']);
    [selected_files,file_dir] = uigetfile('*.tif','MultiSelect','on');

    file_list = motion_correction_HT(file_dir, selected_files); %Comment Out for just trace extraction %Use when don't have MC Vids ##

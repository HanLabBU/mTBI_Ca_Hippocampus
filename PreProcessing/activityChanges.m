...
%save('activityResults_MMDDYYYY_DayX.mat','exppcts','ctlpcts','cell_list','befexppcts','befctlpcts','befcell_list','expplots','ctlplots','CTLorder_bef','CTLorder_aft','TBIorder_bef','TBIorder_aft')